    ...
    <nav className="absolute w-full z-20">
      <div className="px-6 py-6 flex justify-between items-start m-auto md:justify-between lg:max-w-7xl">
        ...
        <div className="md:hidden">
          ...
          <div
            className={`fixed flex flex-col top-0 h-screen w-screen bg-slate-950 bg-opacity-80 backdrop-blur-2xl z-10 transition-all duration-300 ease-in-out pt-28 pl-8 ${
